                             ...
                             LPARAM lParam)
{
   ...
   static int CurrentSearchButton = 0;
    ...
    case WM_COMMAND:
    {
	  ...
	  case ID_BUTTON_ASTAR_SQ:

		  g_Pathfinder->CreatePathAStarSQ(); CurrentSearchButton = ID_BUTTON_ASTAR_SQ; break;

		  break;

	  case ID_BUTTON_ASTAR_MANHATTAN:

		  g_Pathfinder->CreatePathAStarManhattan(); CurrentSearchButton = ID_BUTTON_ASTAR_MANHATTAN; break;
...
HWND CreateToolBar(HWND hwndParent, HINSTANCE hinstMain)
{
  ...
  button[11].iBitmap = 9;
  button[11].idCommand = ID_BUTTON_ASTAR_SQ;
  ...
  button[12].iBitmap = 9;
  button[12].idCommand = ID_BUTTON_ASTAR_MANHATTAN;
