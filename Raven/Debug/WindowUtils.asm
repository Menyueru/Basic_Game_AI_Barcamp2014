; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30723.0 
	...
	TITLE	C:\Users\Menyueru\Desktop\Barcamp2014\Common\misc\WindowUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG135683 DB	'Error', 00H
	ORG $+2
$SG135687 DB	'Error', 00H
	ORG $+2
$SG135831 DB	'*.*', 00H
$SG135832 DB	'All Files (*.*)', 00H
$SG135833 DB	'*.', 00H
CONST	ENDS
PUBLIC	_hypot
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\menyueru\desktop\barcamp2014\common\misc\windowutils.cpp
_TEXT	SEGMENT
$T1 = -42						; size = 1
$T2 = -41						; size = 1
_s$ = -36						; size = 28
...
; 109  :                        "All Files (*.*)" + '\0' + "*.*" + '\0' + '\0';
	...
	push	0
	push	0
	push	OFFSET $SG135831
	push	0
	push	OFFSET $SG135832
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG135833
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
