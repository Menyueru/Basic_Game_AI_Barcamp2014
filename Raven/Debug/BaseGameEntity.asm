; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30723.0 
	...
	TITLE	C:\Users\Menyueru\Desktop\Barcamp2014\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG137036 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG137037 DB	'.', 00H, '.', 00H, '\', 00H, 'C', 00H, 'o', 00H, 'm', 00H
	...
	DB	'p', 00H, 00H, 00H
	ORG $+4
$SG137038 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\menyueru\desktop\barcamp2014\common\game\basegameentity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG137036
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG137037
