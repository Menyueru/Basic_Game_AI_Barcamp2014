; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30723.0 
	...
	TITLE	C:\Users\Menyueru\Desktop\Barcamp2014\Raven\armory\Projectile_Slug.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG153677 DB	'Slug_MaxForce', 00H
	ORG $+2
$SG153678 DB	'Slug_Mass', 00H
	ORG $+2
$SG153679 DB	'Slug_MaxSpeed', 00H
	ORG $+2
$SG153680 DB	'Slug_Scale', 00H
	ORG $+1
$SG153681 DB	'Slug_Damage', 00H
$SG153682 DB	'Slug_Persistance', 00H
	ORG $+3
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\menyueru\desktop\barcamp2014\raven\armory\projectile_slug.cpp
_TEXT	SEGMENT
$T1 = -140						; size = 16
$T2 = -124						; size = 16
$T3 = -108						; size = 16
...
; 32   : {
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG153678
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG153679
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\menyueru\desktop\barcamp2014\raven\armory\projectile_slug.h
