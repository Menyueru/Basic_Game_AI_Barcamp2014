; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30723.0 
	...
	TITLE	C:\Users\Menyueru\Desktop\Barcamp2014\Raven\Raven_SteeringBehaviors.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG151835 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG151836 DB	'SeparationWeight', 00H
	ORG $+3
$SG151837 DB	'WanderWeight', 00H
	ORG $+3
$SG151838 DB	'WallAvoidanceWeight', 00H
$SG151839 DB	'SeekWeight', 00H
	ORG $+1
$SG151840 DB	'ArriveWeight', 00H
	ORG $+3
$SG151841 DB	'ViewDistance', 00H
	ORG $+3
_colors	DD	0ffH
	DD	0ff0000H
	DD	0ff00H
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\menyueru\desktop\barcamp2014\common\game\entityfunctiontemplates.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\menyueru\desktop\barcamp2014\raven\raven_steeringbehaviors.cpp
_TEXT	SEGMENT
$T1 = -20						; size = 16
_this$ = -4						; size = 4
...
; 47   : {
	...
	push	OFFSET $SG151836
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+120]
	push	OFFSET $SG151837
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+128]
	push	OFFSET $SG151838
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [ecx+136]
	push	OFFSET $SG151839
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+144]
	push	OFFSET $SG151840
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+152]
	push	OFFSET $SG151841
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\menyueru\desktop\barcamp2014\raven\raven_steeringbehaviors.h
